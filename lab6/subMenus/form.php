        ...
        <div class="container">
            ...
            <?php } ?>
                ...
                <form action="logic.php" method="POST">
                    ...
                    <input type="number" name="pages" placeholder="Количество страниц"  min="1" max="10000">
                    <input type="number"  name="isbn" placeholder="ISBN" pattern="[0-9\-]+">
                    <input type="number" name="rating" placeholder="Оценка "  min="1" max="10" step="1">
